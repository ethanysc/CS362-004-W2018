...
//Salvager, necessary parameters
int refactored_salvager(int currentPlayer, struct gameState *state, int handPos, int choice1){
  //+1 buy
  state->numBuys++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      //call refactored adventurer function
	  return refactored_adventurer(currentPlayer, state, drawntreasure, cardDrawn, temphand, z);
    ...
    case smithy:
      return refactored_smithy(currentPlayer, state, handPos);

    case village:
  	  return refactored_village(currentPlayer, state, handPos);
    ...
    case minion:
	  return refactored_minion(currentPlayer, state, handPos, choice1, choice2);
    ...
    case salvager:
      return refactored_salvager(currentPlayer, state, handPos, choice1);		
